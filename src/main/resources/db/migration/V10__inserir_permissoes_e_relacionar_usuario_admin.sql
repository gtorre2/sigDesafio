...
INSERT INTO permissao VALUES (3, 'ROLE_CADASTRAR_PRODUTO');
INSERT INTO permissao VALUES (4, 'ROLE_CADASTRAR_CLIENTE');
...
INSERT INTO usuario_grupo (codigo_usuario, codigo_grupo) VALUES (
	(SELECT codigo FROM usuario WHERE email = 'admin@sig.com'), 1);
