Brewer.TabelaItens = (function() {
	...
	function TabelaItens(autocomplete) {
		...
		this.tabelaCervejasContainer = $('.js-tabela-produtos-container');
		this.uuid = $('#uuid').val();
		this.emitter = $({});
	...
	function onQuantidadeItemAlterado(evento) {
		...
		var codigoCerveja = input.data('codigo-produto');
	...
	function onExclusaoItemClick(evento) {
		var codigoCerveja = $(evento.target).data('codigo-produto');
		var resposta = $.ajax({
